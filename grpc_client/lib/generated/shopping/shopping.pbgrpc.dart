...
class ShoppingServiceClient extends $grpc.Client {
  static final _$addItem = $grpc.ClientMethod<$0.AddItemRequest, $0.AddItemResponse>(
      '/flutter_grpc_shopping_list.ShoppingService/AddItem',
      ($0.AddItemRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.AddItemResponse.fromBuffer(value));
  static final _$listItems = $grpc.ClientMethod<$0.ListItemsRequest, $0.ListItemsResponse>(
      '/flutter_grpc_shopping_list.ShoppingService/ListItems',
      ($0.ListItemsRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.ListItemsResponse.fromBuffer(value));
  static final _$deleteItem = $grpc.ClientMethod<$0.DeleteItemRequest, $0.DeleteItemResponse>(
      '/flutter_grpc_shopping_list.ShoppingService/DeleteItem',
      ($0.DeleteItemRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.DeleteItemResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.AddItemResponse> addItem($0.AddItemRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$addItem, request, options: options);
  }

  $grpc.ResponseFuture<$0.ListItemsResponse> listItems($0.ListItemsRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$listItems, request, options: options);
  }

  $grpc.ResponseFuture<$0.DeleteItemResponse> deleteItem($0.DeleteItemRequest request, {$grpc.CallOptions? options}) {
...
abstract class ShoppingServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.AddItemResponse> addItem_Pre($grpc.ServiceCall call, $async.Future<$0.AddItemRequest> request) async {
    return addItem(call, await request);
  }

  $async.Future<$0.ListItemsResponse> listItems_Pre($grpc.ServiceCall call, $async.Future<$0.ListItemsRequest> request) async {
    return listItems(call, await request);
  }

  $async.Future<$0.DeleteItemResponse> deleteItem_Pre($grpc.ServiceCall call, $async.Future<$0.DeleteItemRequest> request) async {
    return deleteItem(call, await request);
  }

  $async.Future<$0.AddItemResponse> addItem($grpc.ServiceCall call, $0.AddItemRequest request);
  $async.Future<$0.ListItemsResponse> listItems($grpc.ServiceCall call, $0.ListItemsRequest request);
  $async.Future<$0.DeleteItemResponse> deleteItem($grpc.ServiceCall call, $0.DeleteItemRequest request);
}
